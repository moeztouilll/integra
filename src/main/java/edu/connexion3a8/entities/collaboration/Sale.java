...
public class Sale {
    ...
    public Sale(long id, String reference, String customerId, long productId, double totalAmount, String currency,
            String status,
    ...
    public Sale(String reference, String customerId, long productId, double totalAmount, String currency, String status,
            String paymentMethod, String paymentStatus, String transactionId, String shippingAddress,
